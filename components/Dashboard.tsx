...
const Dashboard: React.FC<DashboardProps> = ({ stats, onExportData, onDeleteAllData }) => {
    ...
    return (
        <main className="p-4 sm:p-8 pt-24 max-w-4xl mx-auto">
                ...
                <div className="bg-card border border-border rounded-lg p-6">
                    <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between">
                        <div>
                            ...
                            <p className="text-muted-foreground mt-1 text-sm max-w-md">Descarga una copia de seguridad de todos tus marcadores y notas en un archivo JSON.</p>
                        </div>
                        <button 
                    ...
                    <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between">
                         <div>
                            ...
                            <p className="text-muted-foreground mt-1 text-sm max-w-md">
                                Esta acción eliminará permanentemente todos tus marcadores, notas y preferencias de tema de este navegador. No se puede deshacer.
                            </p>
                        </div>
                        <button
